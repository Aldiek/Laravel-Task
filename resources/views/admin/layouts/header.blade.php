...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet"
        href="{{ secure_asset('/') }}/adminLTE/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" />
    ...
    <link href="//cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css" type="text/css" rel="stylesheet" />
    <script src="//cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js" type="text/javascript">
