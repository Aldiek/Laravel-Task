...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="{{ secure_asset('/') }}/adminLTE/index2.html"><b>Admin</b>LTE</a>
        </div>
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ old('name') }}" placeholder="Enter Name" required autocomplete="name"
                            autofocus>
                    ...
                    <div class="input-group mb-3">
                        <input id="password-confirm" type="password" placeholder="Retry Password" class="form-control"
